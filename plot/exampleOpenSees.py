...
## Date - 12/01/2019
## Edited by - Gustavo Araujo, PhD student, Oregon State University
## Date - 4/13/2020
##################################################################
...
# Note: so far, I could not make the recorder command to save data properly.
# If you do not add a wipe() at the end of the analysis, the last line in the 
# file is not completedly printed and numpy.loadtxt will trow an error.
# To solve this issue, I put the model in a function and call it before running
# the plot_deformedshape function 
...
# Run Analysis and save node displacements
# Note: plot_deformedshape contains the recordNodeDisp and plot_deformedshape functions
from plot_deformedshape import * 
fname = 'output.txt'
recordNodeDisp(fname)
analyze(10)

# Load Model (This should not be necessary, but it is the only way the recorder command actually works)
modelfun()
